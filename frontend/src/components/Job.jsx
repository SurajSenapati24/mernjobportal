    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-black border border-gray-100'>
            <div className='flex items-center justify-between'>
                <p className='text-sm text-white'>{daysAgoFunction(job?.createdAt) === 0 ? "Today" : `${daysAgoFunction(job?.createdAt)} days ago`}</p>
            ...
            <div>
                <h1 className='font-bold text-lg text-blue-700 my-2'>{job?.title}</h1>
