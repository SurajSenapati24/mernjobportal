...
const Footer = () => {
  return (
    <footer className="border-t bg-black border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-white">Job Portal</h2>
            <p className="text-sm text-blue-700">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="text-blue-700 hover:text-white" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-blue-700 hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-blue-700 hover:text-gray-400" aria-label="LinkedIn">
